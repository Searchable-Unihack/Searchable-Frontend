...
exports.default = function () {
  ...
  switch (action.type) {
    case 'ADD_VIDEO':
      return _extends({}, state, _defineProperty({}, action.payload.series, [].concat(_toConsumableArray(state[action.payload.series]), [action.payload.video])));
    default:
      return state;
  }
};
