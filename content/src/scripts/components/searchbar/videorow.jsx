  ...
  constructor(props) {
    ...
    if (props.page == 'video') {
      ...
      for (var key in images) {
        if (typeof(images[key])=='object' && images[key].getElementsByTagName('img')[0].src.indexOf(props.id) != -1) {
          this.thumbnailUrl = images[key].getElementsByTagName('img')[0].src.split("poster1")[0] + "thumbnails1/" + Math.round(props.timestamp/60) * 60 + ".jpg";
        }
      }
    }
  }
...
export default connect(mapStateToProps)(VideoRow);
